...
**CustomPromptBot.cs** では、state プロパティを取得し、ヘルパー メソッドを呼び出します  (なお、`_accessors` インスタンス プロパティはボットのコンストラクターで設定されます)。
...
**bot.js** では、state プロパティを取得し、ヘルパー メソッドを呼び出します  (なお、`conversationFlow` インスタンス プロパティはボットのコンストラクターで設定されます)。
