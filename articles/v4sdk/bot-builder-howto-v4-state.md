...
- この記事のコードは、**状態管理ボット** サンプルをベースにしています。 サンプルのコピー ([C#](https://aka.ms/statebot-sample-cs)、[JavaScript](https://aka.ms/statebot-sample-js)、または [Python](https://aka.ms/bot-state-python-sample-code)) が必要になります。
